...
module.exports = function (app) {
    app.on("create", function (context) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, context.config("config.yml")];
                case 1:
                    config = _a.sent();
                    branchNameRegex = new RegExp(config.branchNameRegex || "^[A-Za-z/_-]*[0-9]+[A-Za-z0-9/_-]*$", "g");
                    issueReferenceRegex = new RegExp(config.issueReferenceRegex || "[0-9]+");
