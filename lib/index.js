...
module.exports = function (app) {
    app.on("create", function (context) { return __awaiter(_this, void 0, void 0, function () {
        var payload, config, branchNameRegex, issueReferenceRegex, branchName, regexMatch, issueReference, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    config = _a.sent();
                    branchNameRegex = new RegExp("/^[A-Za-z/-_]*[0-9]+[A-Za-z0-9/-_]*$/g");
                    issueReferenceRegex = new RegExp("/[0-9]+/");
